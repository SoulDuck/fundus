...
def train(max_iter ,learning_rate , check_point,nx=[10,10,10,5,5,5,35], structure='inception_A', optimizer='AdamOptimizer',restored_model_folder_path=None , restored_path_folder_path=None):
    ...
    train_list_imgs_labs, test_list_imgs_labs, train_list_file_paths, test_list_file_paths, names = data.fundus_300x300(reload_folder_path=restored_path_folder_path , n_trains=[None , None , None ,None ,None ,None , 15000])
...
if __name__ == '__main__':
    ...
    train(max_iter=args.max_iter ,learning_rate = args.learning_rate , check_point=args.check_point , structure=args.structure , \
          optimizer=args.optimizer ,restored_path_folder_path=restored_path_folder_path)
