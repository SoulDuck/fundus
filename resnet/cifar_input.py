...
def get_cifar_images_labels(onehot=True):
    train_filenames = glob.glob('./cifar_10/cifar-10-python/cifar-10-batches-py/data_batch*')
    test_filenames = glob.glob('./cifar_10/cifar-10-python/cifar-10-batches-py/test_batch*')
